...
const MorphingIcon = ({ type, isActive, onClick, onMouseEnter }) => {
        ...
        gsap.to(path, {
          keyframes: [
            ...
            },
            {
              ...
              ease: 'elastic.out(1, .9)',
              onStart: () => {
                gsap.to(button, { '--tab-bar-x-scale': 0.7, duration: 0.75, ease: 'elastic.out(1, .9)' });
        ...
        gsap.to(path, {
          keyframes: [
            ...
            },
            {
              ...
              ease: 'elastic.out(1, .9)',
              onStart: () => {
                gsap.to(button, { '--tab-bar-github-scale': 0.7, duration: 0.75, ease: 'elastic.out(1, .9)' });
  ...
  if (type === 'home') {
    return (
      <button ref={buttonRef} onClick={onClick} onMouseEnter={handleMouseEnter} className={cn('home', 'w-full h-full flex items-center justify-center transition-colors duration-200', isActive ? 'text-signal' : 'text-mute')}>
  ...
  if (type === 'blog') {
    return (
      <button ref={buttonRef} onClick={onClick} onMouseEnter={handleMouseEnter} className={cn('blog', 'w-full h-full flex items-center justify-center transition-colors duration-200', isActive ? 'text-signal' : 'text-mute')}>
        <svg viewBox="0 0 24 24" className="w-6 h-6" fill="currentColor">
  ...
  if (type === 'marker') {
    return (
      <button ref={buttonRef} onClick={onClick} onMouseEnter={handleMouseEnter} className={cn('marker', 'w-full h-full flex items-center justify-center transition-colors duration-200', isActive ? 'text-signal' : 'text-mute')}>
        <svg viewBox="0 0 24 24" className="w-6 h-6" fill="currentColor">
  ...
  if (type === 'email') {
    return (
      <button ref={buttonRef} onClick={onClick} onMouseEnter={handleMouseEnter} className={cn('email', 'w-full h-full flex items-center justify-center transition-colors duration-200', isActive ? 'text-signal' : 'text-mute')}>
        <svg viewBox="0 0 24 24" className="w-6 h-6" fill="currentColor">
  ...
  if (type === 'linkedin') {
    return (
      <button ref={buttonRef} onClick={onClick} onMouseEnter={handleMouseEnter} className={cn('linkedin', 'w-full h-full flex items-center justify-center transition-colors duration-200', isActive ? 'text-signal' : 'text-mute')}>
        <svg viewBox="0 0 24 24" className="w-6 h-6" fill="currentColor">
  ...
  if (type === 'x') {
    return (
      <button ref={buttonRef} onClick={onClick} onMouseEnter={handleMouseEnter} className={cn('x', 'w-full h-full flex items-center justify-center transition-colors duration-200', isActive ? 'text-signal' : 'text-mute')}>
        <svg viewBox="0 0 24 24" className="w-6 h-6" fill="currentColor">
  ...
  if (type === 'github') {
    return (
      <button ref={buttonRef} onClick={onClick} onMouseEnter={handleMouseEnter} className={cn('github', 'w-full h-full flex items-center justify-center transition-colors duration-200', isActive ? 'text-signal' : 'text-mute')}>
        <svg viewBox="0 0 24 24" className="w-6 h-6" fill="currentColor">
          <path
            ref={pathRef}
...
export const GlassDock = React.forwardRef(({ items, className, dockClassName, ...props }, ref) => {
    ...
    <div ref={ref} className={cn('w-max', className)} {...props}>
      <div
        className={cn(
          ...
          'border border-line bg-paper/90',
        ...
        {items.map((el, index) => {
          ...
          return (
            ...
            >
              ...
              >
                {isAnimated ? (
                  <MorphingIcon type={type} isActive={isActive} onClick={handleClick} onMouseEnter={() => {}} />
                ) : Icon ? (
                  <Icon
                    className={cn(
                      'h-[22px] w-[22px] transition-colors duration-200',
                      isHovered ? 'text-neutral-900 dark:text-white' : 'text-neutral-500 dark:text-neutral-400'
                    )}
                  />
                ) : null}
              </motion.div>
