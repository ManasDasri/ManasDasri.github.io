              ...
              <div className="flex flex-col gap-3">
                <div className="flex items-center gap-3">
                  ...
                  <div className="min-w-0">
                    ...
                    <div className="font-display text-xs text-mute truncate">@{data.login}</div>
                  </div>
                </div>
                ...
                {data.location && (
                  <div className="flex items-center gap-1.5 text-xs text-mute font-display">
                    <span>📍</span>
                ...
                <div className="flex gap-5 pt-2 border-t border-line font-display text-xs">
                  <span>
                    <strong className="text-text">{data.public_repos}</strong>{' '}
                    <span className="text-mute">repos</span>
                  </span>
                  <span>
                    <strong className="text-text">{data.followers}</strong>{' '}
