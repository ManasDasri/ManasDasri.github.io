...
export const about = [
  'Working on a concept tying together Flow, Velora, Atmos a live 3D physics engine, and a small-scale ML life simulator: Goal is a program that is "alive," based on simple rules similar to Conways Game of Life (over/undercrowding determines survival)',
...
export const projects = [
  {
    ...
    tags: [
      ...
      {label: 'Cloudflare', icon: SiCloudfare}
    ],
